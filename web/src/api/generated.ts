...
export const operations = {
  ...
  getApiParadigmExperiment: { method: "GET", path: "/api/paradigm/experiments/{id}" },
  postApiParadigmEvaluate: { method: "POST", path: "/api/paradigm/evaluate" },
  getApiParadigmHistory: { method: "GET", path: "/api/paradigm/history" },
  ...
  getApiParadigmDiscover: { method: "GET", path: "/api/paradigm/discover" },
  getApiParadigmDecisionCards: { method: "GET", path: "/api/paradigm/decision-cards" },
  getApiParadigmIdLineage: { method: "GET", path: "/api/paradigm/{id}/lineage" },
  getApiParadigmIdVersions: { method: "GET", path: "/api/paradigm/{id}/versions" },
  getApiParadigmIdDiff: { method: "GET", path: "/api/paradigm/{id}/diff" },
  getApiParadigmIdTransitions: { method: "GET", path: "/api/paradigm/{id}/transitions" },
  postApiParadigmHypothesisPreview: { method: "POST", path: "/api/paradigm/hypothesis/preview" },
  postApiParadigmIdTransition: { method: "POST", path: "/api/paradigm/{id}/transition" },
  putApiParadigmIdSnapshot: { method: "PUT", path: "/api/paradigm/{id}/snapshot" },
  ...
  postApiForwardRunsIdSignals: { method: "POST", path: "/api/forward/runs/{id}/signals" },
  ...
  postApiMonitoringRun: { method: "POST", path: "/api/monitoring/run" },
  getApiReviewFailurePatterns: { method: "GET", path: "/api/review/failure-patterns" },
  getApiReviewFeedbackList: { method: "GET", path: "/api/review/feedback/list" },
  getApiReviewList: { method: "GET", path: "/api/review/list" },
  getApiReviewId: { method: "GET", path: "/api/review/{id}" },
  postApiReviewFeedbackGenerate: { method: "POST", path: "/api/review/feedback/generate" },
  postApiReviewFeedbackIdImplement: { method: "POST", path: "/api/review/feedback/{id}/implement" },
  postApiReviewFailureAnalysis: { method: "POST", path: "/api/review/failure-analysis" },
  postApiReviewGenerate: { method: "POST", path: "/api/review/generate" },
  putApiReviewFeedbackId: { method: "PUT", path: "/api/review/feedback/{id}" },
} as const;
